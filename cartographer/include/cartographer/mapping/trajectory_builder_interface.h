...
#include "cartographer/mapping/id.h" // wgh--
...
class TrajectoryBuilderInterface {
 public:
  ...
  // wgh-- A callback which is called when you need to get global point cloud map
  // wgh-- from back-end (i.e., pose graph).
  using GlobalSlamResultCallback =
      std::function<void(int /* trajectory ID */, 
                         common::Time,
                         mapping::NodeId /* latest node contained */,
                         std::shared_ptr<sensor::PointCloud> /* local ground map */)>;
